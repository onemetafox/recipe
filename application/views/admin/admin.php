    ...
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="" class="btn btn-light-primary font-weight-bolder btn-sm" data-toggle="modal" data-target="#kt_select2_modal">Add New Admin</a>
                <!--end::Actions-->
            </div>
            <!--end::Toolbar-->
        </div>
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <!--end::Search Form-->
                    <!--begin: Datatable-->
                    <div class="datatable datatable-bordered datatable-head-custom" id="admin"></div>
                    <!--end: Datatable-->
                </div>
            </div>
            <!--end::Card-->
      ...
      <form class="form" id ="form">
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label class="col-form-label text-right col-lg-3 col-sm-12">Admin Name</label>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
              <input class="form-control form-control-solid form-control-lg" name="email" id="email" type="email" value="" required>
              <div class="fv-plugins-message-container"></div>
            </div>
          </div>
        </div>
...
<script src="<?= asset_url()?>scripts/admin.js"></script>
<script>
